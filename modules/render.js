...
export function modalShell({ eyebrow, title, body, wide = false, className = "" }, escapeHtml) {
  return `<section class="modal${wide ? " wide-modal" : ""}${className ? ` ${escapeHtml(className)}` : ""}">
